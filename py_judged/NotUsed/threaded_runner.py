...
if __name__ == "__main__":
    ...
    runner = Runner("./test_cases/test_case_problem_1.txt", "./code/code_problem_one.py", "./answers/answers_problem_1.txt", os.cpu_count())
    
    test_case_indices = [0, 1, 2]
    print(runner.test_cases(test_case_indices))
